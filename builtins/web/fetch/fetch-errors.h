...
DEF_ERR(InvalidCtorInitArg, JSEXN_TYPEERR, "{0} constructor: |init| parameter can't be converted to a dictionary", 1)
DEF_ERR(NonBodyRequestWithBody, JSEXN_TYPEERR, "Request constructor: HEAD or GET Request cannot have a body", 0)
DEF_ERR(NonBodyResponseWithBody, JSEXN_TYPEERR, "Response with status {0} cannot have body", 1)
...
DEF_ERR(InvalidStatus, JSEXN_TYPEERR, "Response constructor: invalid status {0}", 1)
