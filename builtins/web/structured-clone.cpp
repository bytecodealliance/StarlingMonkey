...
JSObject *ReadStructuredClone(JSContext *cx, JSStructuredCloneReader *r,
  ...
  RootedObject params_obj(
      cx, url::URLSearchParams::create(cx, urlSearchParamsInstance));
  if (!params_obj) {
    return nullptr;
  }
 ...
 * TODO: Add support for CryptoKeys
 */
bool WriteStructuredClone(JSContext *cx, JSStructuredCloneWriter *w,
                          JS::HandleObject obj, bool *sameProcessScopeRequired,
                          void *closure) {
...
JSStructuredCloneCallbacks sc_callbacks = {ReadStructuredClone,
